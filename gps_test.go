...
func TestGpsFromPos(t *testing.T) {
	data := []struct {
		...
		{vec3.T{0, 111189.28, 6.3700295e+06}, drone.Gps{1.0000001, 0, 0}},
		{vec3.T{111189.28, 0, 6.3700295e+06}, drone.Gps{0, 1.0000001, 0}},
		{vec3.T{0, 0, 6.371001e+06}, drone.Gps{0, 0, 1}},
		{vec3.T{111172.34, 111189.28, 6.3690595e+06}, drone.Gps{1.0000001, 1, 0}},
		{vec3.T{-111172.34, 111189.28, 6.3690595e+06}, drone.Gps{1.0000001, -1, 0}},
